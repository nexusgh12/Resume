...
## 현재 진행중인 프로젝트
---
## 1. 카메라 형광측정 PCR 장치의 양성 판정 기준<br> (Positive criteria for camera fluorescence measurement PCR device)
### - 소개
...
## 과거 프로젝트
## 1. Unity AR The Heist(슈팅게임)


### - 소개
Unity 3D Vuforia AR로 개발햇으며, PC 기반으로 실행 및 플레이가 가능합니다.<br>
2명의 멤버로 개발했고, 주인공이 무장강도가 되어 돈을 훔치는 스토리입니다.<br>
최종적으로는 주인공은 경찰에게 체포되는 스토리입니다..<br>

### 세부 플레이 사진
<img src="https://i.esdrop.com/d/lpSlt4DWD0.JPG" width="700" height="600">

<img src="https://i.esdrop.com/d/0NwU8hIuGU.JPG" width="700" height="600">



### - 플레이 영상
[Youtube](https://youtu.be/z7lHqJiv7Ng)
...
## 3. Deep Learning(강아지 품종을 분류하는 앱)
...
두번째 목표는 코로나로 인해 각종 피해가 극심한데, 캡스톤 디자인을 진행하며, <br>
